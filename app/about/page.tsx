...
const timelineData = [
  {
    ...
    details: 'Specialized in Software Engineering and Application Development. Graduated with First Class Honours.',
...
export default function AboutPage() {
  return (
    <div className="container mx-auto p-8 pt-32 text-gray-100"> 
      ...
      <motion.div variants={contentEntrance} initial="initial" animate="animate">
...
{/* SECTION 4: TECHNICAL EXPERTISE - GUARANTEED ALIGNMENT FIX APPLIED */}
          <h2 className="text-3xl font-bold mt-16 mb-8 border-b border-zinc-700 pb-3 text-white">
              Technical Expertise
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-16 gap-y-12 mb-24">
              ...
              <div className="border-l-4 border-sky-600 pl-4"> 
                  ...
                  <ul className="space-y-3 text-gray-300">
                      {/* FIX: Added w-5 to force fixed horizontal position for the text content */}
